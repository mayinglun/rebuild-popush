...
allFileLists.filelistView = allFileLists.SocketView.extend({

	el: '#register',
	//template: _.template(),
	events: {
		'click #reg-btn': 'newfileopen',
		'newfolderopen', 'newfile',
		'sharedfilelist', 'refreshfilelist',
		'share','shareopen', 'initfilelistevent',
	},
	socket_events:{
